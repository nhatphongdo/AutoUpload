...
namespace PhotoshopFile
{
    public static class LayerInfoFactory
    {
        ...
        public static LayerInfo Load(PsdBinaryReader reader, PsdFile psdFile, bool globalLayerInfo)
        {
            ...
            switch (key)
            {
                ...
                case "luni":
                    ...
                    break;
                case "PlLd":
                    result = new PlacedLayerInfo(reader, length);
                    break;
                case "SoLd":
                    result = new LayerSmartObject(reader, length);
                    break;
                case "artb":
                case "artd":
                case "abdd":
                    result = new ArtboardLayerInfo(reader);
                    break;
                case "lnkD":
                case "lnk2":
                case "lnk3":
                    result = new LinkedLayer(reader, psdFile.LoadContext);
                    break;
                default:
    ...
    internal static class LayerInfoUtil
    {
        ...
        internal static LayerInfo FindByKey(this IEnumerable<LayerInfo> list, string key, LayerInfo defaultValue = null) 
        {
    ...
    public abstract class LayerInfo
    {
            ...
            bool isLargeDocument)
        {
            ...
            using (var lengthWriter = new PsdBlockLengthWriter(
                                                               writer,
